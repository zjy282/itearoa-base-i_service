...
class Convertor_Life extends Convertor_Base {
    ...
    public function getAdminLifeListConvertor($lifeList, $lifeCount, $param) {
    	...
    	foreach ($lifeList as $lifes) {
    		...
    		$lifeTemp['detail_lang1'] = Enum_Img::getPathByKeyAndType($lifes['detail_lang1']);
    		$lifeTemp['detail_lang2'] = Enum_Img::getPathByKeyAndType($lifes['detail_lang2']);
    		$lifeTemp['detail_lang3'] = Enum_Img::getPathByKeyAndType($lifes['detail_lang3']);
    		$lifeTemp['lat'] = $lifes['lat'];
    		$lifeTemp['lng'] = $lifes['lng'];
    		$data['list'][] = $lifeTemp;
    	}
	...
	public function getAdminLifeDetailConvertor($lifes) {
		...
		$data['detail_lang1'] = Enum_Img::getPathByKeyAndType ( $lifes['detail_lang1'] );
		$data['detail_lang2'] = Enum_Img::getPathByKeyAndType ( $lifes['detail_lang2'] );
		$data['detail_lang3'] = Enum_Img::getPathByKeyAndType ( $lifes['detail_lang3'] );
		$data ['lng'] = $lifes ['lng'];
		$data ['lat'] = $lifes ['lat'];
		$data ['createTime'] = $lifes ['createtime'];
		$data ['updateTime'] = $lifes ['updatetime'];
